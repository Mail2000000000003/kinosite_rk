...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Desktop\машиностроение\.venv'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('машиностроение-py3.9' == '') {
        $'(char lparen)($virtual_env | path basename)(char rparen) '
    } else {
        '(машиностроение-py3.9) '
    }
...
alias deactivate = source 'C:\Users\User\Desktop\машиностроение\.venv\Scripts\deactivate.nu'
